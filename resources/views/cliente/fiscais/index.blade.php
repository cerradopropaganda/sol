            ...
            <div class="card-content white">
              ...
              <table class="dataTable responsive-table highlight striped">
                ...
                <tbody>
                    ...
                    <tr>
                      <td>
                        <a href="{{route('cliente.fiscais.adicionar')}}" class="btn-floating waves-effect waves-light grey lighten-1"><i class="material-icons">create</i></a>
                      </td>
                      <td>Orgão 1</td>
                      <td>Fiscal 1</td>
                      <td>
                        <!--,$registro->id-->
                        <a href="{{route('cliente.fiscais.deletar') }}" class="btn-floating waves-effect waves-light grey lighten-1"><i class="material-icons">delete_forever</i></a>
                      </td>
                    </tr>
