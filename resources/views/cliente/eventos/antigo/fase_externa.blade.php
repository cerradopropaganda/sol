...
@section('titulo','Documentos da Fase Externa')
        ...
        <div class="col s12 m12">
          ...
          <div class="card ">
            ...
            <div class="card-content teal lighten-2" style="padding: 10px 25px;">
                ...
                <h5 class="card-title  white-text">Selecione os documentos da Fase Externa</h5>
            ...
            <div class="card-content white">
                      ...
                      <form class="" method="post" action="{{ route('cliente.fiscais.salvar')}}">
                        ...
                        <a onclick="location.href ='{{ route('cliente.eventos.fase_externa_download')}}'" class="btn teal lighten-2">GERAR PDFs</a>                       
