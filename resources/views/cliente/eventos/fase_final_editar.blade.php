        ...
        <div class="col s12 m12">
          ...
          <div class="card ">
            ...
            <div class="card-content teal lighten-2" style="padding: 10px 25px;">
                ...
                <h5 class="card-title  white-text">Cadastro do Evento - Fase Final</h5>
	                         ...
	                         <li class="step">
	                            ...
	                            <div class="step-content">
	                               <div class="row">
										...
										<textarea class="" style="height: 600px;" name="edital">{{isset($registro->edital) ? $registro->edital : ''}}
...
14.1.1. Atestado de Capacidade Técnica, expedido por pessoa jurídica de direito público ou privado, que comprove já haver fornecido bens compatíveis ao objeto licitado.
	                               ...
	                               <div class="step-actions">
			                           <button class="waves-effect waves-dark btn teal lighten-2 next-step">IMPRIMIR MINUTA</button>   
	                               </div>
	                            </div>
	                         </li>
	                         ...
	                         <!-- ETAPA 3 -->
	                         <li class="step">
	                            <div data-step-label=""  class="step-title waves-effect waves-dark">Formulário final: data, horário, local e endereço</div>
	                            <div class="step-content">
	                               <div class="row">
										...
										<div class="input-field">
											<input type="text"  name="data_contrato_final" value="{{isset($registro->data_contrato_final) ? $registro->data_contrato_final : ''}}">
	                               ...
	                               <div class="step-actions">
	                                  <button class="waves-effect waves-dark btn teal lighten-2 next-step">SALVAR E IMPRIMIR DOCUMENTOS</button>   
									  <button class="waves-effect waves-dark btn-flat previous-step">VOLTAR</button> 
	                               </div>
	                            </div>
	                         </li>
	                         ...
	                         <!-- ETAPA FINAL -->
	                         <li class="step">
	                            <div data-step-label=""  class="step-title waves-effect waves-dark">Documentação completa</div>
	                            <div class="step-content">
					                ...
					                <tbody>
					                  ...
					                  <tr>
					                    <td>&nbsp&nbsp&nbsp&nbsp<a class="waves-effect waves-dark btn teal lighten-2"><i class="large material-icons left">file_download</i>  DOWNLOAD</a></td>
					                    <td>Anexo VIII: Minuta do Contrato</td>
					                  </tr>
					                </tbody>
					                </table>
					                <br><br>
