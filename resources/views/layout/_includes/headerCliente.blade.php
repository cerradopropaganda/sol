	  		...
	  		<div class="container">
			    ...
			    <div class="nav-wrapper ">
			      ...
			      <ul class="right hide-on-med-and-down">
			        ...
			        @else
			        	<li><i class="material-icons left">assignment_ind</i>{{ Auth::user()->nome_contato }}&nbsp;&nbsp;&nbsp;</li>
					     ...
					     <a href="#" data-activates="mobile-demo" class="teal-text text-lighten-2 button-collapse"><i class="material-icons left">menu</i> MENU</a>
					      ...
					      <!-- Dropdown Cadastro -->
							<ul id="dropdown-cadastro" class="dropdown-content">
							  <li><a class="teal-text text-lighten-2" href="{{route('cliente.orgaos')}}">Orgão Solicitante</a></li>
						  ...
						  <!-- Dropdown Evento -->
							<ul id="dropdown-evento" class="dropdown-content">
							  <li><a class="teal-text text-lighten-2" href="{{route('cliente.eventos.fase_inicial_editar')}}">Novo</a></li>
						  ...
						  <!-- Dropdown Cadastro - Mobile -->
							<ul id="dropdown-cadastro-mobile" class="dropdown-content">
							  <li><a class="teal-text text-lighten-2" href="#!">Orgão Solicitante</a></li>
